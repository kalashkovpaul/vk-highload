...
class HttpServer(unittest.TestCase):
  ...
  def test_directory_index(self):
    ...
    self.conn.request("GET", "/test/dirToTest/")
    r = self.conn.getresponse()
    data = r.read()
  ...
  def test_index_not_found(self):
    ...
    self.conn.request("GET", "/test/deep/")
    r = self.conn.getresponse()
    _ = r.read()
  ...
  def test_file_not_found(self):
    ...
    self.conn.request("GET", "/test/blablabla.html")
    r = self.conn.getresponse()
    _ = r.read()
  ...
  def test_file_in_nested_folders(self):
    ...
    self.conn.request("GET", "/test/deep/deeper/deepest/deep.txt")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    self.assertEqual(int(r.status), 200)
  ...
  def test_file_with_slash_after_filename(self):
    ...
    self.conn.request("GET", "/test/dirToTest/page.html/")
    r = self.conn.getresponse()
    _ = r.read()
    self.assertEqual(int(r.status), 404)
  ...
  def test_file_with_query_string(self):
    ...
    self.conn.request("GET", "/test/dirToTest/page.html?arg1=value&arg2=value")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    self.assertEqual(int(r.status), 200)
  ...
  def test_file_with_spaces(self):
    ...
    self.conn.request("GET", "/test/s%20p%20a%20c%20e.txt")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    self.assertEqual(int(r.status), 200)
  ...
  def test_large_file(self):
    ...
    self.conn.request("GET", "/test/wikipedia_russia.html")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    self.assertEqual(int(r.status), 200)
  ...
  def test_document_root_escaping(self):
    ...
    self.conn.request("GET", "/test/../../../../../../../../../../../../../etc/passwd")
    r = self.conn.getresponse()
    _ = r.read()
  ...
  def test_file_with_dot_in_name(self):
    ...
    self.conn.request("GET", "/test/text..txt")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    self.assertEqual(int(r.status), 200)
  ...
  def test_post_method(self):
    ...
    self.conn.request("POST", "/test/dirToTest/page.html")
    r = self.conn.getresponse()
    _ = r.read()
  ...
  def test_head_method(self):
    ...
    s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    s.connect((self.host, self.port))
    s.send(b"HEAD /test/dirToTest/page.html HTTP/1.0\r\n\r\n")
    data = b""
    while 1:
      buf = s.recv(1024)
      if not buf:
  ...
  def test_file_type_css(self):
    ...
    self.conn.request("GET", "/test/css.css")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
  ...
  def test_file_type_js(self):
    """Content-Type for .js"""
    self.conn.request("GET", "/test/js.js")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
  ...
  def test_file_type_jpg(self):
    ...
    self.conn.request("GET", "/test/jpg.jpg")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
  ...
  def test_file_type_jpeg(self):
    ...
    self.conn.request("GET", "/test/jpeg.jpeg")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
  ...
  def test_file_type_png(self):
    ...
    self.conn.request("GET", "/test/png.png")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
  ...
  def test_file_type_gif(self):
    ...
    self.conn.request("GET", "/test/gif.gif")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
  ...
  def test_file_type_swf(self):
    ...
    self.conn.request("GET", "/test/swf.swf")
    r = self.conn.getresponse()
    data = r.read()
    length = r.getheader("Content-Length")
    ctype = r.getheader("Content-Type")
